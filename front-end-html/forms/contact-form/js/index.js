    ...
    render: function(){
        return (
            React.createElement("div", {className: "control"},
                React.createElement("input", {type: "text", id: "name", ref: "nameField", placeholder: "What should we call you?", autoFocus: true, required: true, onChange: this.handleTextChange}),
...
var EmailInput = React.createClass({displayName: "EmailInput",
    ...
    render: function(){
        return (
            React.createElement("div", {className: "control"},
                React.createElement("input", {type: "email", id: "email", ref: "emailField", placeholder: "Where can we reach you?", required: true, onChange: this.handleTextChange}),
